                ...
                <form method="post">
                    ...
                    $id = $_GET['id'];
                        if(isset($_POST['submit'])) {
                            ...
                            $query = mysqli_query($koneksi, "UPDATE buku set id_category='$id_category', judul='$judul', penulis='$penulis', penerbit='$penerbit', tahun_terbit='$tahun_terbit', deskripsi='$deskripsi' WHERE id_buku=$id");
