            ...
            <div class="col-md-12">
                ...
                <?php
                        if(isset($_POST['submit'])) {
                            ...
                            $query = mysqli_query($koneksi, "INSERT INTO buku(id_category,judul,penulis,penerbit,tahun_terbit,deskripsi) VALUES('$id_category','$judul','$penulis','$penerbit','$tahun_terbit','$deskripsi')");
